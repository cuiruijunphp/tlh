...
function add_answer() {
    ...
    $('#answers').append('<div class="every_answers">'+letter_num_arr[(num+1)]+':<input type="checkbox" name="which" value="' + (num + 1) + '"><input type="text" name="answer' + (num + 1) + '" class="form-control" placeholder="请输入答案"><span class="glyphicon glyphicon-trash" onclick="del_answer('+(num+1)+')"></span></div>')
}
// 删除第i个答案
