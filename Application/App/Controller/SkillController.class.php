...
class SkillController extends BaseController {
    ...
    public function get_skill_type_list(){
		...
		$skill_type_result = $skill_type_model->get_list(['is_show' => 1], null, 'sort asc,add_time desc');
	...
	public function get_skill_info(){
		...
		if(!$is_other){
			...
			$skill_reserve_list = $skill_reserve_model->get_skill_reserve_by_skill_id($skill_id, null, null, '2,3,4');
